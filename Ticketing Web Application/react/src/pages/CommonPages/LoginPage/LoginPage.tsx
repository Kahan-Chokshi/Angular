      ...
      <GrayCard cssClasses={[classes.card]}>
        <div className={classes.loginFlexContainer}>
          ...
          <div className={classes.loginFormContainer}>
            <h1 className={classes.mainText}>Welcome To Air Bus</h1>
            <Route path={loginLink} exact>
              <LoginUI />
            </Route>
            <Route path={emailLoginLink}>
              <EmailLogin />
            </Route>
            {/* <Route path={googleLoginLink}><GmailLogin/></Route> */}
            <Route path={emailPasswordResetLink}>
              <FormEmailPasswordReset />
            </Route>
            <Route path={emailRegisterLink}>
              <FormEmailRegister />
            </Route>
            <Route path={phoneRegisterLink}>
              <FormPhoneRegister />
            </Route>
            <Route path={phoneOtpLink}>
              <FormPhoneOTP />
            </Route>
