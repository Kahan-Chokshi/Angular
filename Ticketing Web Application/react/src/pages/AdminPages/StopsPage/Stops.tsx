...
const Stops: React.FC<{}> = () => {
  ...
  const isAddOpen = useSelector(
    (state: RootState) => state.stopsList.isAddOpen
  );
  const isEditOpen = useSelector(
    (state: RootState) => state.stopsList.isEditOpen
  );
  const isDeleteOpen = useSelector(
    (state: RootState) => state.stopsList.isDeleteOpen
  );
  const stopId = useSelector(
    (state: RootState) => state.stopsList.selectedStopId
  );
  useEffect(() => {
