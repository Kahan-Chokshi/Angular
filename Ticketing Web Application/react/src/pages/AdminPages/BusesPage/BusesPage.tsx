...
const BusesPage: React.FC<{}> = () => {
  ...
  const isAddOpen = useSelector(
    (state: RootState) => state.busesList.isAddOpen
  );
  const isEditOpen = useSelector(
    (state: RootState) => state.busesList.isEditOpen
  );
  const isDeleteOpen = useSelector(
    (state: RootState) => state.busesList.isDeleteOpen
  );
  const busId = useSelector(
