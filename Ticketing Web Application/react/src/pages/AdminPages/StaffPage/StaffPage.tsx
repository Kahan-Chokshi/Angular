...
const StaffPage: React.FC<{}> = () => {
  ...
  const isAddOpen = useSelector(
    (state: RootState) => state.staffList.isAddOpen
  );
  const isChangeBusOpen = useSelector(
    (state: RootState) => state.staffList.isChangeBusOpen
  );
  const isResetPasswordOpen = useSelector(
    (state: RootState) => state.staffList.isResetOpen
  );
  const isDeleteOpen = useSelector(
    (state: RootState) => state.staffList.isDeleteOpen
  );
  const selectedStaffId = useSelector(
    (state: RootState) => state.staffList.selectedStaffId
  );
  useEffect(() => {
