...
const emailFormErrorDispatcher = (
...
const emailFormSuccessDispatcher = (
  forElement: ForElement,
  dispatch: React.Dispatch<emailFormAction>,
  enteredValue: string
) => {
...
const phoneFormErrorDispatcher = (
  forElement: phoneForElement,
  dispatch: React.Dispatch<phoneFormAction>,
  errorMessage: string
) => {
  dispatch({ type: `setIs${forElement}Valid`, payload: false });
  dispatch({ type: `set${forElement}ErrorMessage`, payload: errorMessage });
};
const phoneFormSuccessDispatcher = (
  forElement: phoneForElement,
  dispatch: React.Dispatch<phoneFormAction>,
  enteredValue: number
) => {
