        ...
        {props.subItems.map((subItem) => {
          ...
          if (subItem.type === "normal") {
            return (
              <p
                key={props.subItems?.indexOf(subItem)}
                className={`${classes.subItemLink} ${classes.logout}`}
  ...
  if (props.location) {
    ...
    NavItem = (
      <>
        <li>
          <p
            className={`${classes.navDefault} ${classes.pItem}`}
