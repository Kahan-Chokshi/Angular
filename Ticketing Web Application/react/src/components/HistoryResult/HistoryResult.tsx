    ...
    <div className={classes.container}>
      ...
      <div className={classes.subContainer1}>
        ...
        <div className={classes.subContainer2}>
          ...
          >{`Number of Tickets : ${props.numberOfTickets}`}</p>
        </div>
        <div className={classes.subContainer2}>
          <p className={classes.text}>{`Source : ${props.source}`}</p>
          <p className={classes.text}>{`Destination : ${props.destination}`}</p>
        </div>
        <div className={classes.subContainer2}>
          <p className={classes.text}>{`Booked Time : ${props.bookedTime}`}</p>
          <p className={classes.text}>{`have Used : ${
            props.hasUsed ? "Yes" : "No"
          }`}</p>
        </div>
      </div>
