...
const FormPhoneOTP: React.FC<{}> = () => {
  const otpToken = useSelector((state: RootState) => {
    return state.auth.otpToken;
  });
    ...
    <div className={"formContainer"}>
      ...
      <form className={"formStyle"} onSubmit={onSubmitHandler}>
        <GradientInput
          ...
          onBlurHandler={onOTPBlurHandler}
          onChangeHandler={onOTPChangeHandler}
        />
        {!state.isOTPValid && state.OTPErrorMessage.length > 0 && (
