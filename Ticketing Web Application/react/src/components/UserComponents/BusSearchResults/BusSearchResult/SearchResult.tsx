...
const SearchResult: React.FC<{ busId: string; busNumber: string }> = (
  props
) => {
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.busDetails}>
        ...
        <p className={`${classes.pText} ${classes.boldFont}`}>
          {props.busNumber}
        </p>
      </div>
      <div className={classes.controls}>
        <button className={classes.controlButtons} onClick={onDecreaseClicked}>
          -
        </button>
        <p className={`${classes.pText} ${classes.ticketCount}`}>
          {numberOfTickets}
        </p>
        <button className={classes.controlButtons} onClick={onIncreaseClicked}>
          +
        </button>
        <NormalGradientButton
          text={"BuyNow"}
          buttonColor={"green"}
          cssClassesOnContainer={[classes.buyButton]}
